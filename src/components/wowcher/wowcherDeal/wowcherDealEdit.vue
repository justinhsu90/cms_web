    ...
    <div class="p10">
      ...
      >
        ...
        >
          <el-row :gutter="20">
            ...
            <el-col :span="4">
              <el-form-item label="幣別">
                ...
                >
                  <el-option
                    v-for="(v,i) in searchCurrencyOption"
                    :key="'country'+i"
                    :label="v.currency"
                    :value="v.currency"
                  >
          ...
          <el-row :gutter="20">
            <el-col :span="5">
              <el-form-item label="中文申報名">
                <el-input v-model="v.declareNameChinese"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="5">
              <el-form-item label="英文申報名">
