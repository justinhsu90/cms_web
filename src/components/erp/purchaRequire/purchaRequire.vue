    ...
    <div>
        <el-row>
            <el-col :span="22">
                ...
                <el-select class="w-max150" placeholder="樣品" v-model="searchAccount" @change="handleCondition('acc')" clearable>
                    <el-option v-for="(v,i) in searchAccountOption" :key="'acc'+i" :label="v" :value="v"></el-option>
                </el-select>
                <el-select class="w-max150" placeholder="購買" v-model="searchLanguage" @change="handleCondition('lang')" clearable>
