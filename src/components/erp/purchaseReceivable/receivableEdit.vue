    ...
    <div id="purchaseAdd">
        <div style="padding:20px">
            ...
            <el-form ref="form" :model="formData" v-loading="loading" label-position="top">
                <el-row :gutter="10">
                    <el-col :span="3">
                        <el-form-item label="應收帳款類型" prop="purchaseType" :rules="rules">
                    ...
                    <el-col :span="3">
                        <el-form-item label="應收帳款平台" prop="purchasedPlatform" :rules="rules">
                    ...
                    <el-col :span="3">
                        <el-form-item label="應收帳款帳號" prop="purchasedAccount" :rules="rules">
                    ...
                    <el-col :span="5">
                        <el-form-item label="平台單號" prop="purchaseOrderId" :rules="rules">
                            <el-input v-model="formData.purchaseOrderId"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="4">
                        <el-form-item label="時間" prop="purchasedTime" :rules="rules">
