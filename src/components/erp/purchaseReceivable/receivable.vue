...
export default {
    ...
    created() {
        let receivablePlatform = axios({
            url: "/accountreceivable/platform",
            method: "post",
            data: {
                token: this.token
            }
        ...
        let receivableType = axios({
            url: "/accountreceivable/financialSpendType ",
            method: "post",
            data: {
                token: this.token
            }
        ...
        let receivableCountry = axios({
            url: "/accountreceivable/country",
            method: "post",
            data: {
                token: this.token
            }
        });
        Promise.all([receivablePlatform, receivableType, receivableAccount, receivableCountry]).then(
            ([platform, type, account, country]) => {
