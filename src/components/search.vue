    ...
    <div>
        ...
        <el-col>
               <el-table :data="tableData" v-loading="isTableLoading" @sort-change="handleSortChange">   
                 ...
                 <el-table-column width="80" label="agent" prop="agent" sortable="custom"></el-table-column>
                 ...
                 <el-table-column width="80" label="colour" prop="colour"></el-table-column>
                  ...
                  <el-table-column width="80" label="customerName" prop="customerName" sortable="custom"></el-table-column>
                  ...
                  <el-table-column width="80" label="orderStatus" prop="orderStatus" sortable="custom"></el-table-column>
                  <el-table-column width="80" label="orderType" prop="orderType" sortable="custom"></el-table-column>
                  <el-table-column width="80" label="phone" prop="phone" sortable="custom"></el-table-column>
                  <el-table-column width="80" label="platformOrderId" prop="platformOrderId"></el-table-column>
                  <el-table-column width="80" label="postcode" prop="postcode" sortable="custom"></el-table-column>
                  ...
                  <el-table-column width="80" label="redeemedAt" prop="redeemedAt" sortable="custom"></el-table-column>
                  <el-table-column width="80" label="shipoutTime" prop="shipoutTime"></el-table-column>
                  <el-table-column width="80" label="shippingMethod" prop="shippingMethod" sortable="custom"></el-table-column>
                  <el-table-column width="80" label="sku" prop="sku"></el-table-column>
                  <el-table-column width="80" label="spec" prop="spec"></el-table-column>
                  <el-table-column width="80" label="trackingNo" prop="trackingNo" sortable="custom"></el-table-column>
                  <el-table-column width="80" label="wowcherCode" prop="wowcherCode" sortable="custom"></el-table-column>
        </el-table> 
        </el-col>
