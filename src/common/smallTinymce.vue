  ...
  data() {
    ...
    return {
      ...
      DefaultConfig: {
        ...
        theme: "modern",
        menubar: false,
        toolbar: `styleselect | underline strikethrough | image  media | table | alignleft aligncenter alignright alignjustify | outdent indent | numlist bullist | preview removeformat  hr | paste code  link | undo redo | fullscreen `,
        plugins: `
            paste
            importcss
            image
